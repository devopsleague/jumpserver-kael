...
class Session(_message.Message):
    __slots__ = ["id", "user", "asset", "account", "login_from", "remote_addr", "protocol", "date_start", "org_id", "user_id", "asset_id", "account_id"]
...
class TerminalTask(_message.Message):
    __slots__ = ["id", "action", "session_id", "terminated_by"]
    ID_FIELD_NUMBER: _ClassVar[int]
    ACTION_FIELD_NUMBER: _ClassVar[int]
...
class ComponentSetting(_message.Message):
    ...
    max_idle_time: int
    def __init__(self, max_idle_time: _Optional[int] = ...) -> None: ...
...
class PublicSetting(_message.Message):
    __slots__ = ["xpack_enabled", "valid_license"]
